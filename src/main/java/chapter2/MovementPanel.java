...
public class MovementPanel extends BasicGameState {
    ...
    private void drawYLine(Graphics graphics, int i) {
        graphics.drawLine(FRAME_WIDTH - MeasureLineLength, (float) height + FRAME_WIDTH - i, FRAME_WIDTH + MeasureLineLength, (float) height + FRAME_WIDTH - i);
        graphics.drawString("" + i, FRAME_WIDTH - graphics.getFont().getWidth("" + i) - 2 * MeasureLineLength, (float) height + FRAME_WIDTH - i - (float) graphics.getFont().getHeight("i") / 2);
    }
    ...
    private void drawXLine(Graphics graphics, int i) {
        ...
        graphics.drawString("" + i, i + FRAME_WIDTH - (float) graphics.getFont().getWidth("" + i) / 2, (float) height + FRAME_WIDTH + 2 * MeasureLineLength);
    }
